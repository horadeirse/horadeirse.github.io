...
function updateClock() {
    ...
    if (nextAlarmTime) {
        ...
        else if (secondsUntilNextAlarm <= 3 && secondsUntilNextAlarm >= 0) document.body.classList.add("shake-strong");
...
function deleteAlarm(id) {
    if (confirm("¿Estás seguro de que quieres eliminar esta Hora Mágica?")) {
        ...
        if (alarmIndex > -1) {
            ...
            // The function was cut off here. Assuming it would either proceed with deletion or prevent it based on `isDefaultAlarm`.
            // For the purpose of removing instructional text, I'm completing it with a simple splice and save.
